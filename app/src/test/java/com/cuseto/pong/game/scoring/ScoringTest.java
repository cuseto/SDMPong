...
class ScoringTest {
    ...
    void scoreIsUpdatedWhenBallCrossesBoundaryDuringGameUpdate() {
        ...
        ScoreGameUpdater scoreGameUpdater = new ScoreGameUpdater();
        BallGameUpdater ballGameUpdater = new BallGameUpdater();

        GameUpdater updater = ballGameUpdater.andThen(scoreGameUpdater);
        ...
        // First frame: establish the ball's previous position.
        updater.update(gameSession, 0.0);

        // Second frame: ball crosses the right scoring boundary.
